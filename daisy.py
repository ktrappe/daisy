...
def pipeline(args):
    ...
    if (args.donor is not None):
        hgteval_vcf = '{}{}_hgt_eval_{}_{}_{}.vcf'.format(args.outdir, args.task, readname, accref, donref)
        ...
        for don_gi, don_id in get_GIs(args.donor2):
            hgteval_vcf = '{}{}_hgt_eval_{}_{}_{}.vcf'.format(args.outdir, args.task, readname, accref, don_id)
            if args.b_eval and (args.b_new or not checkExistence(logger,'Sorting Mapping', hgteval_vcf)):
